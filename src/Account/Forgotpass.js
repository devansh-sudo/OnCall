...
export default class Forgotpass extends React.Component {
    ...
    render() {
      ...
      <View
        ...
        <Text style = {{color:'black',textAlign:'center',marginTop:30,fontSize:16,marginHorizontal:40}}>Please enter you registerd mobile number , we'll send you a six digit verification code</Text>
